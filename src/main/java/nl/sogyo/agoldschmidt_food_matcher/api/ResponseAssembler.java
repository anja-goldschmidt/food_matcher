...
class ResponseAssembler {
    ...
    DemandOfferPair[][] createSelectionPairs(User user) {
    ...
    ClientData createClientData(User user, Offer[] offerArray, Demand[] demandArray, Matches[] matchesArray, DemandOfferPair[][] selectionPairs) {
