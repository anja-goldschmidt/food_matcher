...
public class LocationMatcherTest {
    ...
    public void testCalculateDistance() {
        ...
        Matches calculatedMatches = locationMatcher.matchViaGpsLocation(contentMatches);
        // assertEquals(contentLocationMatches, calculatedMatches);
        assertTrue(calculatedMatches.getMatchingOffers().length == 1);
        assertEquals(offerBarber, calculatedMatches.getMatchingOffers()[0]);
    }
}